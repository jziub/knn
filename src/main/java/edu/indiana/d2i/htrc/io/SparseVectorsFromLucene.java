...
public class SparseVectorsFromLucene extends Configured implements Tool {
	
	private static final Log logger = LogFactory.getLog(SparseVectorsFromLucene.class); 
...
//	    job.getConfiguration().set(HTRCConstants.DICTIONARY_PATH, dictDir);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),
				new SparseVectorsFromLucene(), args);
		System.exit(res);
	}
}
