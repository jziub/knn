...
public class SparseVectorsFromSolr extends Configured implements Tool {
	
	private static final Log logger = LogFactory.getLog(SparseVectorsFromSolr.class); 
...
//	    job.getConfiguration().set(HTRCConstants.DICTIONARY_PATH, dictDir);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(),
				new SparseVectorsFromSolr(), args);
		System.exit(res);
	}
}
