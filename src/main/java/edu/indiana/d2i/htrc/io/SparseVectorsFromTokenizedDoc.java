...
#
# Project: knn
# File:  SparseVectorFromTokenizedDoc.java
# Description:  
#
# -----------------------------------------------------------------
# 
...
/**
 * Slightly modified version of SparseVectorsFromSequenceFiles
 * Input is tokenized doc
 */
public final class SparseVectorsFromTokenizedDoc extends AbstractJob {

	private static final Logger log = LoggerFactory
			.getLogger(SparseVectorsFromTokenizedDoc.class);

	public static void main(String[] args) throws Exception {
		ToolRunner.run(new SparseVectorsFromTokenizedDoc(), args);
	}
