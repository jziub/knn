 ...
 */
public class TokensInspection extends Configured implements Tool {
	private static final Log logger = LogFactory.getLog(TokensInspection.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Configuration(), new TokensInspection(), args);
		System.exit(0);
	}
}
